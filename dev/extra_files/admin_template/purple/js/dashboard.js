(function($) {
  ...
  $(function() {
    ...
    if ($("#sales-chart").length) {
      ...
      gradientStroke1.addColorStop(0, 'rgba(236, 129 ,13, 0.9)');
      gradientStroke1.addColorStop(1, 'rgba(236, 129 ,13, 0.9)');

      var gradientStroke2 = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStroke2.addColorStop(0, 'rgba(183, 16 ,34, 0.9)');
      gradientStroke2.addColorStop(1, 'rgba(183, 16 ,34, 0.9)');
    ...
    if ($("#satisfaction-chart").length) {
      ...
      gradientStrokeBluePurple.addColorStop(0, '#ec810d');
      gradientStrokeBluePurple.addColorStop(1, '#b71022');
      var myChart = new Chart(ctx, {
          type: 'bar',
          data: {
